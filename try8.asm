...
draw_line macro x0, y0, x1, y1, color
local row,border,l,m
pusha    
mov di, y1
mov si, x1
...
draw_line get_cell_x , get_cell_y, dist_x, get_cell_y, 5
draw_line get_cell_x , get_cell_y, get_cell_x, dist_y, 5
draw_line dist_x , get_cell_y, dist_x, dist_y, 5
draw_line get_cell_x , dist_y, dist_x, dist_y, 5
...
draw_line get_cell_x , get_cell_y, dist_x, get_cell_y, al
draw_line get_cell_x , get_cell_y, get_cell_x, dist_y, al
draw_line dist_x , get_cell_y, dist_x, dist_y, al
draw_line get_cell_x , dist_y, dist_x, dist_y, al
